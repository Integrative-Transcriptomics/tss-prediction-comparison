...
- **Rollenverteilung** (PO / SM / Dev ): Der PO ist der Betrueer (M. Witte Paz). Bei jedem Sprint hat ist ein anderer Studierender Scrum Master (wird bekannt gegeben). Alle Studierenden sind Teil vom Entwicklerteam. Unabhängig von der Rollenverteilung ist es notwendig zum Bestehen, dass _jede(r)_ TeilnehmerIn aktiv programmiert.
...
- Aufgaben sind ausreichend dokumentiert, so dass _alle_ Beteiligten genau wissen, was sie zu tun hätten
...
- Continue hier with definition of DONE.
