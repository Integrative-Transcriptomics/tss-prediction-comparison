...
class MyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tss_rv_list = [1005, 26695, 33500, 26696, 32000]
        ...
        self.classification_rv = pd.DataFrame({
            "Pos": [1005, 26695, 33500, 26696, 32000],
            ...
            "distance": [None, 0, 2138, 1, 638]})

        self.mastertable = pd.DataFrame({
            "Pos": [1005, 26700, 33500, 26691, 405, 20100, 12520, 22000],
            "Strand": ["-", "-", "-", "-", "+", "+", "+", "+"],
